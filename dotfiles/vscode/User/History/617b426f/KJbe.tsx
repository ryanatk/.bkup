...
const HorizonPDP = ({
  ...
  const seoParams = useMemo(() => {
    const { title: t, description: d } = product?.seoParams ?? {};
    const title =
      product?.seoParams?.title &&
      formatMessage({ id: product?.seoParams?.title });
    const description =
      product?.seoParams?.description &&
      formatMessage({ id: product?.seoParams?.description });
