    ...
    >
      <PageContainer name="fsa-hsa-info" padding="none">
        <Grid className="pb-20 lg:pt-10">
          <div className="col-main lg:col-start-3 lg:col-span-7 xl:col-start-3 xl:col-span-7">
            <FsaProductSlideshow />
          </div>

          <div className="col-main lg:col-start-10 lg:col-span-3 xl:col-start-10 xl:col-span-3 flex items-center">
            <FsaProductDetails />
          </div>
        </Grid>
