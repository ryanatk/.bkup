  ...
  const handleProceedToCart = () => {
    ...
    dispatch(
      cartActions.reqUpdateCartItemsAction({
        ...
        quantity: getAddQuantity(cart, variantId),
...
// util to get the quantity for adding to cart
export function getAddQuantity(cart: CartState, variantId: number): number {
  ...
  const inCart = isCumulative ? lineItem?.quantity ?? 0 : 0;
