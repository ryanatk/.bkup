    ...
    <section className="bg-helsinkiBlue-dark py-20 lg:py-24">
      <Grid>
        ...
        <Typography
          Element="ul"
          color="white"
          className="col-main md:row-start-2 md:col-start-2 md:col-span-6 lg:row-start-1 lg:col-start-6 lg:col-span-4"
        >
        ...
        <Typography
          Element="ul"
          color="white"
          className="col-main md:row-start-2 md:col-start-8 md:col-span-6 lg:row-start-1 lg:col-start-10 lg:col-span-4"
        >
