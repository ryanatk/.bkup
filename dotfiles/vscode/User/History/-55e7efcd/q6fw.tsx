  ...
  return (
    <section className="bg-helsinkiBlue-dark">
      <Grid>
        ...
        >
          <DescriptionItem icon="lungs" title="24/7 Heart Rate">
          ...
          <DescriptionItem icon="lungs" title="Accuracy Above All">
          ...
          <DescriptionItem icon="lungs" title="Measure Your HRV">
        ...
        >
          ...
          <DescriptionItem icon="lungs" title="Trends">
          ...
          <DescriptionItem icon="lungs" title="Control Your Health">
