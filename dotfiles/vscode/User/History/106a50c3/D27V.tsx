...
const BusinessHero = (): ReactElement => {
  ...
  return (
    <section className="pb-20 md:pb-24">
      ...
      <Grid
        style={{
          background: 'linear-gradient(#F6F3EF 50%, #FFF 50%)',
        }}
        className="mb-48 md:mb-20"
      >
        <div
          className={cx('col-main md:col-start-3 md:col-end-13', 'relative')}
        >
          <div
            style={{
              height: isMediumScreen ? '34rem' : '24rem',
            }}
          >
