...
import { ConnectButton, Em, ParallaxImage, Title, Typ } from './components';
...
const BusinessHero = (): ReactElement => {
  ...
  return (
    ...
    >
        ...
        <div className={cx('col-main md:col-start-3 md:col-end-13 relative')}>
          <div style={{ height: isMediumScreen ? '34rem' : '24rem' }}>
            <ParallaxImage
              src={
                isMediumScreen
                  ? src('business/d-hero@2x', 'jpg', 1200)
                  : src('business/m-hero@2x', 'jpg', 600)
              }
      ...
      <Grid>
        <Typ
          variant={isMediumScreen ? 'h6' : 'body'}
          Element="h2"
