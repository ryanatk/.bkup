...
const MARKER: {
  ...
  I: {
    Element: 'h2',
    variant: 'h2',
    style: { listStyleType: 'upper-roman', textTransform: 'uppercase' },
  },
  A: {
    Element: 'h3',
    variant: 'h3',
    style: { listStyleType: 'upper-alpha', textTransform: 'uppercase' },
  },
  i: {
    Element: 'h4',
    variant: 'h4',
    style: { listStyleType: 'lower-roman', textTransform: 'uppercase' },
  },
  a: {
    Element: 'h5',
    variant: 'h5',
    style: { listStyleType: 'lower-alpha', textTransform: 'uppercase' },
  },
...
const Item = ({
  ...
  const { Element, variant, style } = MARKER[level];
