...
const MARKER: {
  ...
  I: { Element: 'h2', variant: 'h2', classNames: ['list-upper-roman'] },
  A: { Element: 'h3', variant: 'h3', classNames: ['upper-alpha'] },
  i: { Element: 'h4', variant: 'h4', classNames: ['lower-roman'] },
  a: { Element: 'h5', variant: 'h5', classNames: ['lower-alpha'] },
