...
import { MainContent } from '../../components/sormus';
...
import { reqAnalyticsEvent, reqSegmentEvent } from '../../stores/app/actions';
...
const Page = () => {
  ...
  return (
    <div className="tailwind">
      <NextSeo {...checkoutPageDetails.seoParams} />
