...
// fallback image, to allow us to avoid layout shift
const FALLBACK_IMAGE: PDPData_content_productByHandle_images = {
  alt: '',
  originalSrc: '',
  thumbnailSrc: '',
...
const ProductHorizonSlideshow = (): JSX.Element => {
  ...
  // const images: PDPData_content_productByHandle_images[] = ready
  //   ? getImages(product.images, variantId)
  //   : [];

  const images: PDPData_content_productByHandle_images[] = ready
    ? getImages(product?.images ?? [FALLBACK_IMAGE], VariantId.One)
    : [FALLBACK_IMAGE];

  // const images: PDPData_content_productByHandle_images[] = [FALLBACK_IMAGE];
