...
const processCartPayment = async (order) => {
  ...
  await VALID.checkAll(
    ['customerId', order.customerId, VALID.CUSTOMER_ID],
    [
      'exhibitorAddressId',
      order.exhibitorAddressId,
      VALID.EXHIBITOR_ADDRESS_ID,
    ],
    ['billingAddressId', order.billingAddressId, VALID.BILLING_ADDRESS_ID],
