...
// import '../components/sormus/fonts.scss';
...
/**
 * Once we upgrade nextjs past 10.2, we can instead use
 * <link rel="stylesheet" href="/css/fonts.css" />
 * to inline these critical styles.
 */
const FONT_FACE = `
@font-face {
  font-family: 'AkkuratLL'; font-weight: 400;
  src: url('/fonts/AkkuratLL-Regular.woff2') format('woff2');
}
@font-face {
  font-family: 'AkkuratLL'; font-weight: 300;
    ...
    return (
      <Html>
        <Head>
          ...
          <link rel="preload" href="/fonts/AkkuratLL-Regular.woff2" />
          <link rel="preload" href="/fonts/AkkuratLL-Light.woff2" />
          <style
            dangerouslySetInnerHTML={{
              __html: `
                @font-face {
