...
const Page = ({ authToken }) => {
  ...
  const isCountryEnabled = checkFeatureFlag('membership-country-enable');
  console.log(
    { billingAddress, isCountryEnabled },
    Boolean(billingAddress?.country) || !isCountryEnabled,
  );
              ...
              steps={[
                {
                  ...
                  RenderEditView: ({ handleContinue, loading }) => (
                    <CheckoutBillingForm
                      ...
                      disableCountry={
                        !isCountryEnabled || Boolean(billingAddress?.country)
                      }
                      onSubmit={(address) => {
                        dispatch(
                          reqMyOrderUpdatePaymentMethodBillingAddress({
