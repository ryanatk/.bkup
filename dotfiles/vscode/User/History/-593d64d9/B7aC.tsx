...
const Page = ({ authToken }) => {
  ...
  console.log({
    ...
    enable: enableCountryDropdown || !Boolean(billingAddress?.country),
    disable: !(enableCountryDropdown || !Boolean(billingAddress?.country)),
              ...
              steps={[
                {
                  ...
                  RenderEditView: ({ handleContinue, loading }) => (
                    <CheckoutBillingForm
                      ...
                      disableCountry={
                        !(
                          enableCountryDropdown || // feature flag to force enabling
                          !Boolean(
                            billingAddress?.country, // if not forced, disable when country is preselected
                          )
                        )
                      }
                      onSubmit={(address) => {
