...
const ProductSpecs = () => (
  <Grid className="bg-helsinkiBlue-dark py-24">
    <Grid className={cx(styles.grid, 'col-main md:col-start-3 md:col-end-13')}>
      <div className="col-main md:col-end-13 lg:col-end-5 lg:row-start-4">
        <Typography variant="h4" Element="h3" color="white">
          {t('all_features')}
        </Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-5">
      ...
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-6">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('rest_mode')}
        </Typography>
        <Typography color="white">{t('rest_mode_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-7">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-8">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('trends')}
        </Typography>
        <Typography color="white">{t('trends_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-9">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('tags')}
        </Typography>
        <Typography color="white">{t('tags_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-10">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-4">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-5">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-6">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-7">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-8">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('oura_stickers')}
        </Typography>
        <Typography color="white">{t('oura_stickers_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-9">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('activity_levels')}
        </Typography>
        <Typography color="white">{t('activity_levels_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-10">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('bedtime_guidance')}
        </Typography>
        <Typography color="white">{t('bedtime_guidance_body')}</Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-11">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
    ...
    <Grid
      className={cx(
        styles.grid,
        'col-main md:col-start-3 md:col-end-13 lg:col-end-5',
      )}
    >
      <div className="col-main md:col-end-13 lg:col-end-5 lg:row-start-1">
        <Typography variant="h4" Element="h3" color="white">
          {t('tech_specs')}
        </Typography>
      </div>
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-9">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-6 lg:col-end-8">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10 lg:row-start-1">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-end-13 lg:col-start-10">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
