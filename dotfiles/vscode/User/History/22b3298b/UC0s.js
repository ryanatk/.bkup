...
import { getSiteProps, track } from 'common/utils';
import {
  Alert,
  Checkbox,
  Error,
      ...
      <div className={styles.alert}>
        <Alert>
          <p className={styles.p}>
            Welcome to {ORG === 'Edlen' ? "Edlen's" : 'our'} new Online Ordering
            system!
          </p>
          <p className={cx(TEXT.BOLD, styles.p)}>
            All users must create a new account.
          </p>
