...
import { PAYMENT_METHOD, PAYMENT_METHOD_TX } from 'common/const';
import { useCartTotals, useEvent } from 'common/hooks';
import { calculateCartTotals, currency } from 'common/utils';
...
const useEventPaymentMethods = () => {
  ...
  const {
    data: paymentMethodsForEventData = [],
    isLoading,
    error,
  } = useQuery(
