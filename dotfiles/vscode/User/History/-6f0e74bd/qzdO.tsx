  ...
  return (
    ...
    >
      <Grid className="gap-y-2 md:gap-y-5">
        <div
          className={cx('col-start-2 col-end-6 md:col-start-4 md:col-end-13')}
        >
          <Title h1>
            <FormattedMessage
        ...
        <div className="row-start-2 col-start-3 col-end-6 md:col-start-6 md:col-end-13 lg:col-end-11">
