...
export const ExperienceHero = (): JSX.Element => {
  ...
  return (
    <section
      className="bg-sand text-grayMedium pt-3 h-screen md:pt-5 md:pb-24 flex flex-col"
      id="hero"
    >
      ...
      <div className="w-10/12 self-end pt-5 md:col-start-4 overflow-hidden md:mb-24">
        <Image
          src={
            isLargeScreen
