  ...
  return (
    ...
    >
      <Grid className="gap-y-2 md:gap-y-5">
        ...
        <div className="row-start-2 col-start-3 md:col-start-6 md:col-end-13 lg:col-end-10">
          <Subtitle small>{t('experience_hero_subtitle')}</Subtitle>
        </div>

        <div className="col-full pt-5 md:col-start-3">
          <Image
            src={
              isMediumScreen
                ? src('experience/d-hero-img-oe2x', 'jpg', 1800)
                : src('experience/m-hero-img-oe2x', 'jpg', breakpoints.medium)
            }
            alt=""
            loading="eager"
          />
