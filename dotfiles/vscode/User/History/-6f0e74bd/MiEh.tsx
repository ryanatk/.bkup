...
export const ExperienceHero = (): JSX.Element => {
  ...
  return (
    <section
      className="bg-sand text-grayMedium pt-3 h-screen md:pt-5 md:pb-24"
      id="hero"
    >
      <Grid className="gap-y-2 md:gap-y-5 h-full">
        ...
        <div className="col-full pt-5 md:col-start-4 overflow-hidden md:mb-24">
          <Image
            src={
              isLargeScreen
