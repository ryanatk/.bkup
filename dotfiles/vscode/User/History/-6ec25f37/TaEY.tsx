...
const ExperienceCounter = (): JSX.Element => {
  ...
  return (
    <div className="bg-helsinkiBlue-dark relative h-screen">
      <Image
      ...
      <div className={styles.content}>
        <Typography variant="h6" color="white" className="mb-5">
          <strong className="font-bold">{t('readiness_sequence_title')}</strong>
        </Typography>
          ...
          {({ countUpRef, start, reset }) => (
            ...
            >
              <div className={styles.progress}>
                ...
                <div className={cx(styles.circle, { fill: playAnimation })} />
              </div>
