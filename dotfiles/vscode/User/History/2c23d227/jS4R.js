...
import { Button, QuantityButton, SubmitButton, Toast } from 'common/components';
...
const AddToCart = ({ item }) => {
  ...
  const [{ updateQuantity }, setState] = useState({
  ...
  const handleUpdateQuantity = useCallback(
    (qtyAdd) => {
      ...
      if (remainder) {
        // show toast
        setState({ updateQuantity: qtyAdd - remainder + item.updateIncrement });
      } else {
