...
import getHubSpotHtmlStyles from './getHubSpotHtmlStyles';

// eslint-disable-next-line @typescript-eslint/no-var-requires
const styles = require('!!raw-loader!./hubSpotIframe.css').default;
/**
 * TODO: in webpack 5, raw-loader is deprecated & replaced with asset/source rule
 * https://webpack.js.org/guides/asset-modules/
 * We can update then, or just find another way to:
 * 1. send CSS as a string, and
 * 2. make the dev experience not terrible
 */
...
const useHubSpotForms = (
  ...
  useEffect(() => {
    const cleanUpFn = addScript(hubSpot, {
  ...
  const createForm = () => {
    ...
    window.hbspt.forms.create({
      ...
      target: '#' + id,
      cssRequired: isIframeEnabled ? styles : getHubSpotHtmlStyles(id),
