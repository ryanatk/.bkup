    ...
    <Section id="relax">
      ...
      <Feature
        ...
        imageProps={{
          ...
          alt: formatMessage({ id: 'experience_rest_feature_1_alt' }),
        }}
      >
        <Typography
          color="plum-light"
      ...
      <Feature
        ...
        imageProps={{
          ...
          alt: formatMessage({ id: 'experience_rest_feature_2_alt' }),
        }}
        reverse
      />
      ...
      <div>
        <Feature
          ...
          imageProps={{
            ...
            alt: formatMessage({ id: 'experience_rest_feature_3_alt' }),
          }}
        />
      </div>
    </Section>
