...
describe('Header Component (Horizon)', () => {
  test('Renders the offcanvas on mobile when hideLinks is true', () => {
    useMediaQuery.mockReturnValue(false); // set to not-large screen
<<<<<<< HEAD
=======
...
>>>>>>> origin/staging
  ...
  test(`Doesn't render the offcanvas on desktop when hideLinks is true`, () => {
<<<<<<< HEAD
    useMediaQuery.mockReturnValue(true); // set to large screen
=======
    useMediaQuery.mockReturnValue(false); // set to not-large screen
...
>>>>>>> origin/staging
  ...
  test('Shows/hides offcanvas when hamburger button is clicked', () => {
    render(<Header />);
    expect(screen.queryByTestId('nav_offcanvas_closed')).toBeTruthy();
  ...
  test(`Renders the cart button when user has selected items`, () => {
  ...
  test(`Doesn't render the cart button when showCart is false`, () => {
    useSelector.mockImplementation(() => ({
      totalCount: 2,
    }));
  ...
  test(`Renders the CTA when hideLinks is true`, () => {
    render(<Header hideLinks />);
