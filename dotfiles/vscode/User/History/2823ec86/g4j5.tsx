...
const LOGOS = [LOGO.NAVY, LOGO.ARMY, LOGO.UFC];
    ...
    <div className="md:pt-24">
      ...
      >
        <Typ
          ...
          className="bg-sand-light p-6 lg:p-8 rounded-xl mt-10 lg:mt-20 w-full lg:w-80"
        >
          <Typ Element="h4" className="mb-5 lg:mb-8 text-center lg:text-left">
            {t('business_feature_trusted_by')}
          </Typ>

          <ul className="flex gap-4 md:gap-8 lg:gap-16 items-center justify-between">
