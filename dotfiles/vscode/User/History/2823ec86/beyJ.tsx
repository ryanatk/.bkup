    ...
    <div className="md:pt-24">
      ...
      <Feature
        ...
        image={{
          ...
          alt: 'business_feature_3_alt',
        }}
      >
        <Typ
          Element="ul"
          color="grayscale-text"
          className="bg-sand-light p-6 lg:p-8 rounded-xl mt-20 w-full lg:w-auto"
        >
