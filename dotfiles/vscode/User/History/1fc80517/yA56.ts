...
interface UseAccordionA11yOptions {
  isOpen: boolean;
  setIsOpen: Dispatch<SetStateAction<boolean>>;
  matchLargeScreen: boolean;
}

interface UseAccordionA11yState {
...
const useAccordionA11y = ({
  isOpen,
  setIsOpen,
  matchLargeScreen,
}: UseAccordionA11yOptions): UseAccordionA11yState => {
  ...
  const onKeyup = setupKeyup({
    ...
    // focusedLinkIndexRef,
    onTraverse: (i) => (focusedLinkIndexRef.current = i),
...
export default useAccordionA11y;
