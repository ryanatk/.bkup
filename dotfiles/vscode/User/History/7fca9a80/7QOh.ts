...
const READINESS_SLIDESHOW_ITEMS: IntlSlideshowItem[] = [
  {
    src: src('experience/d-oe-readiness-5050-carousel-img-01@2x', 'jpg', WIDTH),
    mobileSrc: src(
  ...
  {
    src: src('experience/d-oe-readiness-5050-carousel-img-02@2x', 'jpg', WIDTH),
    mobileSrc: src(
      'experience/m-oe-readiness-5050-carousel-img-02@2x',
      'jpg',
      WIDTH,
    ),
  ...
  {
    src: src('experience/d-oe-readiness-5050-carousel-img-03@2x', 'jpg', WIDTH),
    mobileSrc: src(
      'experience/m-oe-readiness-5050-carousel-img-03@2x',
      'jpg',
      WIDTH,
    ),
