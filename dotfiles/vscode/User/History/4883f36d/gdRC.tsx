      ...
      <PageContainer name="privacy-policy-oura-health">
        <Grid>
          <TypographyRhythm className="col-main lg:col-start-3 lg:col-end-13">
            ...
            >
              ...
              >
                ...
                <OL spacing="double">
                  ...
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item4"
                    values={{
                      a(chunks: string[]) {
                        return (
                          <a
                            href={`/${selectedLocale}/cookie-policy`}
                            className="underline"
                          >
                            {chunks}
                          </a>
              ...
              >
                ...
                <OL spacing="double">
                  ...
                  <LI
                    tx="privacy_policy_oh_personal_store_purposes_item5"
                    values={{
                      a(chunks: string[]) {
                        return (
                          <a
                ...
                <Heading
                  level="i" // II.B.ii
                  tx="privacy_policy_oh_personal_store_basis_heading"
                />

                <P tx="privacy_policy_oh_personal_store_basis_p1" />
                <OL>
                  <LI tx="privacy_policy_oh_personal_store_basis_item1" />
                  <LI tx="privacy_policy_oh_personal_store_basis_item2" />
                  <LI tx="privacy_policy_oh_personal_store_basis_item3" />
                  <LI tx="privacy_policy_oh_personal_store_basis_item4" />
                </OL>
            ...
            <P
              tx="privacy_policy_oh_cookies_p3"
              values={{
                a(chunks: string[]) {
                  return (
                    <a
            ...
            <OL>
              <LI tx="privacy_policy_oh_rights_item1">
                ...
                <P
                  tx="privacy_policy_oh_rights_item1_p2"
                  values={{
                    a(chunks: string[]) {
                      return (
                        <a
            ...
            <P tx="privacy_policy_oh_contact_ourahealth" />
            <P tx="privacy_policy_oh_contact_ouraring" />
