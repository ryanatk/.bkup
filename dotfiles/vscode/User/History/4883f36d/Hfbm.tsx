        ...
        <Grid>
          <TypographyRhythm className="col-main lg:col-start-3 lg:col-end-13">
            ...
            <section>
              ...
              />
              <P tx="privacy_policy_oh_personal_store_p1" />
              ...
              <P tx="privacy_policy_oh_personal_store_source_p2" />
              ...
              <ol>
                <LI tx="privacy_policy_oh_personal_california_info_item1" />
                <LI tx="privacy_policy_oh_personal_california_info_item2" />
                <LI tx="privacy_policy_oh_personal_california_info_item3" />
              </ol>
