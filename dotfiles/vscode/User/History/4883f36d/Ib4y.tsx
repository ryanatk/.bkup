          ...
          <TypographyRhythm className="col-main lg:col-start-3 lg:col-end-13">
            ...
            >
              ...
              >
                ...
                <ol>
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item1"
                    spacing="double"
                  />
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item2"
                    spacing="double"
                  />
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item3"
                    spacing="double"
                  />
                  <LI
                  ...
                  />
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item5"
                    spacing="double"
                  />
                  <LI
                    tx="privacy_policy_oh_personal_device_purposes_item6"
                    spacing="double"
                  />
                </ol>
