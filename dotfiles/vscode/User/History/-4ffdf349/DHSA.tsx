...
import QUOTE_SLIDER_DATA from './mock-data';
...
const QuoteSlider = ({
  quotes = QUOTE_SLIDER_DATA,
}: QuoteSliderProps): JSX.Element => {
  ...
  const data = prefersReducedMotion
    ? QUOTE_SLIDER_DATA
    : [...QUOTE_SLIDER_DATA, ...QUOTE_SLIDER_DATA];
