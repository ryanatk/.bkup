...
const reducer = (state, { type, payload }) => {
  ...
  const { quantity, message } = getQuantity({ ...state, quantity: payload });
  ...
  switch (type) {
    case TYPE.UPDATE: {
      return {
        ...
        quantity,
        message,
        incrementTo: getIncrementTo({ ...state, quantity: payload }),
        decrementTo: getDecrementTo({ ...state, quantity: payload }),
      };
    }
