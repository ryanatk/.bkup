...
const ImageScroller = ({
  ...
  const mirrorFn = (target, mirrorEl) =>
    (mirrorEl.current.scrollLeft = target.current.scrollLeft);
  const addScroll = (target, mirrorEl) =>
    target.current.addEventListener('scroll', mirrorFn(target, mirrorEl));
