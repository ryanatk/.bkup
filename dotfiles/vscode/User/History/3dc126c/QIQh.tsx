...
const CartPage = ({ details }): JSX.Element => {
  ...
  const MAX_ITEMS_PER_ORDER = !isChargerSetDisabled ? 10 : 1;
  ...
  */
  ...
  const tooManyCartItems = getCartIconCount(cart) > MAX_ITEMS_PER_ORDER;

  const alertMessage = isMultiLineEnabled
    ? tooManyCartItems
      ? t('cart_one_item_per_order') /* TODO: update with new message */
      : null
    : cartHasItems
    ? t('cart_one_item_per_order') /* TODO: remove once multi-ring is perm */
    : null;
