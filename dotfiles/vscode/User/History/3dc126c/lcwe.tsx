...
const CartPage = ({ details }): JSX.Element => {
  ...
  const tooManyCartChargers = chargerCount > MAX_CHARGERS_PER_ORDER;
  console.log({ MAX_CHARGERS_PER_ORDER, chargerCount, tooManyCartChargers });
            ...
            <Grid>
              <div className="col-main lg:mx-24">
                ...
                <CartQuantityAlert
                  ...
                  maxRings={MAX_RINGS_PER_ORDER}
                  maxChargers={MAX_CHARGERS_PER_ORDER}
                />
