...
const getProductContent = (handle, subPrice, oneMonthEnabled) => {
  if (!handle) return;
  ...
  return [
    {
      ...
      content: (
        <TypographyRhythm>
          ...
          <Typography>
            {t('pdp_horizon_description_wearing_instructions')}
          </Typography>
        </TypographyRhythm>
      ),
    },
        ...
        <>
          <TypographyRhythm>
            <Typography>
              {t(
                oneMonthEnabled
                  ? 'pdp_horizon_onemonth_membership_trial'
                  : 'pdp_horizon_membership_description_trial',
                {
                  price: subPrice,
                },
              )}
            ...
            <Typography>
              {oneMonthEnabled
                ? t('one_month_pdp_membership_description')
