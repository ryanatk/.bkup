...
const Slideshow = ({
  ...
  /**
   * Using a combined state to avoid race conditions
   * when updating multiple values at once.
   * (Updating separately was causing a "flicker"
   *  when `nextItem` updates before `currentIndex`)
   */
      ...
      <div
        className={cx(
          styles.Slideshow,
          {
            ...
            [styles['Slideshow--Horizon']]: !darkMode,
          },
          className,
        )}
      >
