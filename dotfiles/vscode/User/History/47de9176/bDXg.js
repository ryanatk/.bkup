...
describe(`Checkout Flow > Paypal (US Customer)`, () => {
  ...
  it(`Directs the user to the PDP`, () => {
    cy.getCy('page-horizon-pdp', { isring: true }).should('exist');
  });

  it(`Allows the user to add a ring to their cart`, () => {
  ...
  it(`Directs the user to the Cart`, () => {
  ...
  it(`Displays the correct line items and subtotal`, () => {
    assertOrderDetails([
      {
