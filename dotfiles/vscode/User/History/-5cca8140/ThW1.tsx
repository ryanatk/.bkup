...
import { ButtonColor } from '../../../sormus/Button';
...
const HealthJourneyBanner = ({
  ...
  className,
  mobileImage = src('simple-home/m-home-shop-cta-img-xl@2x', 'jpg', 1024, 's'),
  desktopImage = src('simple-home/d-home-shop-cta-img-xl@2x', 'jpg', 2000, 's'),
}: Props): JSX.Element => {
    ...
    <Grid className={className}>
      <div className="col-full lg:px-6">
        <ParallaxBanner className={styles.Banner}>
          ...
          >
            <Image
              src={matchMediumScreen ? desktopImage : mobileImage}
              alt=""
              loading="lazy"
