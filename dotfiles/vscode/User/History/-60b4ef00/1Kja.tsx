...
import IconMobileFriendly from '../../../../svg/design-tokens/icon_mobile_friendly.svg';
      ...
      <TOC
        entries={[
          <TOCEntry
            ...
            key="toc-pdp_highlights_titanium_body"
          />,
          <TOCEntry
            ...
            key="toc-bilbo_battery_life"
          />,
          <TOCEntry
            label={t('apple_health_google_fit_compatible')}
            icon={
              <Icon>
                <IconMobileFriendly />
              </Icon>
            }
            key="toc-apple_health_google_fit_compatible"
          />,
          <TOCEntry
          ...
          <TOCEntry
            ...
            key="toc-lightweight_titanium_durable"
          />,
        ]}
      />
    </div>
