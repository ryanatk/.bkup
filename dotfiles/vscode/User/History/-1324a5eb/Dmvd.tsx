...
const accoladesData: AccoladeDataType[] = [
  {
    ...
    source: {
      name: 'USA Today',
      logo: 'accolades/usa-today-logo.svg',
    },
  },
  {
    ...
    source: {
      name: 'Wareable',
      logo: 'accolades/wareable-logo.svg',
    },
  },
  {
    ...
    source: {
      ...
      logo: 'accolades/washington-post-logo.svg',
    },
  },
];
          ...
          >
            <blockquote className="flex flex-row-reverse items-center">
              ...
              <footer className="flex-shrink-0 mr-6 lg:mr-8">
                <Image
                  shortSrc={item.source.logo}
                  alt={item.source.name}
                  className={cx('h-6 max-w-none lg:h-9', {
                    'text-white': dark,
                  })}
                />
              </footer>
