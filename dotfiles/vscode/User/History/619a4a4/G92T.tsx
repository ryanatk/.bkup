...
import { getFeatureImageProps } from './utils';
  ...
  return (
    <Section padTop id="sleep">
      ...
      <Feature
        ...
        imageProps={{
          ...getFeatureImageProps('experience/oe-ui-sleep-01@3x'),
      ...
      <Feature
        ...
        imageProps={{
          ...getFeatureImageProps('experience/oe-ui-sleep-02@3x'),
      ...
      <Waypoint onEnter={onWaypointEnter}>
        <div>
          <Feature
            ...
            imageProps={{
              ...getFeatureImageProps('experience/oe-ui-sleep-03@3x'),
          ...
          <Feature
            ...
            imageProps={{
              ...getFeatureImageProps('experience/oe-ui-sleep-04@3x'),
