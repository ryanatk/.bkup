    ...
    <Section id="rest">
      ...
      <div className="flex flex-col gap-24 mt-32 md:mt-20 lg:mt-32">
        <FeaturedSection
          ...
          mainImage={{
            src: 'experience/d-oe-self-care-01.jpg',
            alt: formatMessage({ id: 'experience_rest_image_1_alt' }),
          }}
          sideImage={{
            src: `experience/oe-rest-ui.png`,
            alt: formatMessage({ id: 'experience_rest_image_1_ui_alt' }),
          }}
        />
        ...
        <FeaturedSection
          ...
          mainImage={{
            src: 'experience/d-oe-self-care-02.jpg?s', // cachebuster
            alt: formatMessage({ id: 'experience_rest_image_2_alt' }),
          }}
          sideImage={{
            src: `experience/oe-nap-ui.png`,
            alt: formatMessage({ id: 'experience_rest_image_2_ui_alt' }),
          }}
          reverse
        />
      </div>
