...
import { isRunningInCypress } from '../../../utils/cypress';
...
const generateDefaultPreferences = (isEU) => {
  if (isEU || isRunningInCypress()) return saveCustomPreferences();
        ...
        return (
          <div className="tailwind">
            {bannerVisible && (
              <>
                <div
                  className="fixed bottom-0 w-screen bg-white py-8 border-t border-t-helsinkiBlue"
                  style={{ zIndex: 51 }} // 1 higher than our highest tailwind z-index of z-50
                >
