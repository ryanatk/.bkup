...
describe('addItemsToCart', () => {
  ...
  it('supports adding a single item', async () => {
    const { addItemsToCart, cart: emptyCart } = setup();
  ...
  it('supports adding a second item', async () => {
    const { addItemsToCart, cart: emptyCart } = setup();
  ...
  it('includes the currencyCode when fetching discounts', async () => {
    ...
    const { addItemsToCart, cart: emptyCart } = CartService({
      ...state,
