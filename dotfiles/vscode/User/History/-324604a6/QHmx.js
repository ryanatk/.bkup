...
const fillCheckoutSteps = (state = {}, options = {}) => {
  ...
  if (state.giftOptions) {
    it(`Allows the customer to enter gift options`, () => {
      ...
      cy.getCy('checkout-gift-options-next-button')
        .should('be.visible')
        .click();
  ...
  it(`Allows the customer to enter delivery address`, () => {
    ...
    cy.getCy('checkout-delivery-next-button').should('be.visible').click();
  ...
  if (state.shippingMethod) {
    it(`Allows the customer to enter shipping method`, () => {
      ...
      cy.getCy('checkout-shipping-method-next-button')
        .should('be.visible')
        .click();
  ...
  it(`Allows the customer to enter billing address`, () => {
    ...
    cy.getCy('checkout-billing-next-button').should('be.visible').click();
