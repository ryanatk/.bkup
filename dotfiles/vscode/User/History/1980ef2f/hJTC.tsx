...
import { useEyebrowContext } from '../EyebrowCTA/EyebrowCTAProvider';
...
const Header: React.FC<HeaderProps> = React.forwardRef(function Header(
  {
    bordered,
    shopButton = { label: t('header_shop_now'), target: undefined },
    hideLinks = false,
    inverse = false,
    showCart = true,
  ...
  const showMembershipLink =
    membershipPageTestReady && membershipPageTestVariantId === VariantId.Two;
      ...
      >
        <Grid className="items-center">
          ...
          <div className={styles.header__mobile_controls}>
            ...
            {displayCart && (
              <Link href="/cart">
                <a className={!hideLinks ? 'mr-4' : ''} data-cy="link-to-cart">
                  <ShoppingBag
                    count={cartCount}
                    inverse={isDeepScroll ? false : inverse}
                  />
