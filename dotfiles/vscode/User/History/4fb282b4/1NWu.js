...
import { Content, Dialog, IconButton, Loading } from 'common/components';
  ...
  return (
    ...
    >
      ...
      <Dialog
        ...
        size="xs"
        isOpen={Boolean(thirdParty)}
        close={() => setThirdParty(undefined)}
        onCancel={() => setThirdParty(undefined)}
        onSubmit={() => {}}
        submitText="Yes, Continue"
        cancelText="Cancel"
        href={thirdParty.redirectUrl}
      >
        <p>
          You will be redirected to{' '}
          <span className={TEXT.BOLD}>
            {thirdParty.facilityName} Exhibitor Services
          </span>{' '}
          to place your order. Do you want to continue?
        </p>
      </Dialog>
    </Content>
  );
