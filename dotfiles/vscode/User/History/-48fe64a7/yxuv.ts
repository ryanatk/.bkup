...
export type MessageKey =
  ...
  | 'footnote_personal_baseline'
  | 'footnote_sleep_algorithm'
  | 'footnote_spo2'
  | 'footnote_warranty'
  | 'footnote_workout_heartrate'
  | 'footnotes_membership_pricing'
  ...
  | 'membership_accolades_slide_1_text'
  | 'membership_accolades_slide_2_text'
  | 'membership_accolades_slide_3_text'
  | 'membership_accolades_slide_4_text'
  | 'membership_accolades_slide_5_text'
  | 'membership_accolades_slide_6_text'
  | 'membership_accolades_slide_7_text'
  | 'membership_accolades_slide_8_text'
  | 'membership_accolades_slide_9_text'
  | 'membership_accolades_title'
  | 'membership_benefits_coming_soon_bullet_1'
  | 'membership_benefits_coming_soon_title'
  | 'membership_benefits_evolving_body'
  | 'membership_benefits_evolving_title'
  | 'membership_benefits_first_six_months_body'
  | 'membership_benefits_first_six_months_title'
  | 'membership_benefits_nonpaying_members_body'
  | 'membership_benefits_nonpaying_members_title'
  | 'membership_faq_answer_1'
  | 'membership_faq_answer_2'
  | 'membership_faq_answer_3'
  | 'membership_faq_answer_4'
  | 'membership_faq_answer_5'
  | 'membership_faq_answer_6'
  | 'membership_faq_answer_7'
  | 'membership_faq_question_1'
  | 'membership_faq_question_2'
  | 'membership_faq_question_3'
  | 'membership_faq_question_4'
  | 'membership_faq_question_5'
  | 'membership_faq_question_6'
  | 'membership_faq_question_7'
  | 'membership_faq_title'
  | 'membership_features_and_so_much_more'
  | 'membership_features_audio_sessions_body'
  | 'membership_features_audio_sessions_title'
  | 'membership_features_bedtime_guidance_body'
  | 'membership_features_bedtime_guidance_title'
  | 'membership_features_close'
  | 'membership_features_highlight_body_temp'
  | 'membership_features_highlight_health_insights'
  | 'membership_features_highlight_heart_rate_monitoring'
  | 'membership_features_highlight_sleep_analysis'
  | 'membership_features_rest_mode_body'
  | 'membership_features_rest_mode_title'
  | 'membership_features_restorative_time_body'
  | 'membership_features_restorative_time_title'
  | 'membership_features_sp02_body'
  | 'membership_features_sp02_title'
  | 'membership_features_tags_body'
  | 'membership_features_tags_title'
  | 'membership_features_title'
  | 'membership_features_track_movement_body'
  | 'membership_features_track_movement_title'
  | 'membership_features_trends_body'
  | 'membership_features_trends_title'
  | 'membership_features_view_all_features'
  | 'membership_features_workout_heart_rate_tracking_body'
  | 'membership_features_workout_heart_rate_tracking_title'
  | 'membership_hero_cta'
  | 'membership_hero_subtitle'
  | 'membership_hero_title'
  | 'membership_payment_method'
  | 'membership_your_health_body'
  | 'membership_your_health_bottom'
  | 'membership_your_health_title'
  | 'modal_add_warranty'
  ...
  | 'product_size_title'
  | 'product_specs_app_availability_body'
  | 'product_specs_app_availability_title'
  ...
  | 'raf_step_4'
  | 'raf_step_5'
  | 'raoptics_hero_subtitle'
  | 'raoptics_hero_title'
  | 'raoptics_paragraph_2'
  | 'raoptics_paragraph_3'
  | 'raoptics_paragraph_4'
  ...
  | 'strava_data_share'
  | 'strava_easy_app_connect'
  | 'strava_eyebrow_message'
  | 'strava_features_activity_detection_description'
  | 'strava_features_activity_detection_title'
  | 'strava_features_heart_rate_description'
  | 'strava_features_heart_rate_title'
  | 'strava_features_readiness_score_description'
  | 'strava_features_readiness_score_title'
  | 'strava_features_sickness_detection_description'
  | 'strava_features_sickness_detection_title'
  | 'strava_features_sleep_score_description'
  | 'strava_features_sleep_score_title'
  | 'strava_features_title'
  | 'strava_hero_subtitle'
  | 'strava_hero_title'
  | 'strava_instructions'
  | 'strava_need_app'
  | 'strava_oura_app_content'
  | 'strava_oura_section_title'
  | 'strava_product_closeup_description'
  | 'strava_product_closeup_title'
  | 'strava_signup'
  | 'submit'
...
export type LocaleMessagesJson = Record<
  MessageKey,
  { one: string; other: string } | string
>;
