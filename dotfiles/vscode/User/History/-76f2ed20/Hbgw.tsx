...
const ProductSpecs = () => (
  <div className="bg-helsinkiBlue-dark py-24 flex flex-col-reverse">
    <Grid>
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-end-5">
    ...
    <Grid>
      ...
      <hr className="col-main md:col-start-3 md:col-end-13 border-grayscale-dark my-16" />
    </Grid>
    ...
    <Grid>
      ...
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-1">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-2">
      ...
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-start-6 lg:col-end-9 lg:row-start-3">
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
          {t('rest_mode')}
        </Typography>
      ...
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-start-10 lg:row-start-2">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
      ...
      <div className="col-main md:col-start-3 md:col-end-13 lg:col-start-10 lg:row-start-3">
        <Typography variant="eyebrow" color="success">
          {t('new')}
        </Typography>
        <Typography variant="h6" Element="h4" color="white" className="mb-4">
