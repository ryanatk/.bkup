...
const CartProductParent = ({
  ...
  return (
    <div className="flex items-start justify-between">
      <div className="flex flex-col md:flex-row md:gap-4 flex-nowrap w-full">
        <LineItemImage
          width="130"
          productData={productData}
          lineItem={lineItem}
          className="flex-grow-0 flex-shrink-0 self-center md:self-start h-24 w-36 relative overflow-hidden"
          imageClassName="absolute -top-4"
        />

        <div className="py-6 flex flex-row flex-nowrap gap-8 w-full">
