...
const CartProductParent = ({
  ...
  return (
    <div className="flex flex-col md:block md:items-start md:gap-4 flex-nowrap w-full">
      <LineItemImage
        width="130"
        productData={productData}
        lineItem={lineItem}
        // className="flex-grow-0 flex-shrink-0 self-center md:self-start h-24 w-36 relative overflow-hidden mb-4 md:mb-0"
        className="flex-grow-0 flex-shrink-0 self-center h-30 w-36 float-left mb-4 md:mb-0"
