...
const Feature = ({
  ...
  const spring =
    useSpring({
      opacity: visible ? '1' : '0',
      transform: `translate3d(0, ${visible ? '0' : '20px'}, 0)`,
      config: { ...config.molasses },
    }) ?? {};

  return (
    <a.div style={spring}>
      {/* Hidden span, for internal anchor.
          Leave room for the header when scrolling to the section */}
      <span id={id} className="relative -top-36" />
