...
export const MESSAGE_SUCCESS_TAF_ONE_MONTH =
  'bilbo_banner_message_tell_a_friend_onemonth';
...
const getDiscountAppliedMessage = (
  ...
  switch (campaign) {
    case CAMPAIGN_TAF:
      return oneMonthEnabled
        ? MESSAGE_SUCCESS_TAF_ONE_MONTH
        : MESSAGE_SUCCESS_TAF;
    case CAMPAIGN_RAF:
      return isRAFMessageEnabled ? MESSAGE_SUCCESS_RAF : defaultMessage;
...
const getDiscountMessage = (
  ...
  return getDiscountAppliedMessage(
    discountData,
    isRAFMessageEnabled,
    oneMonthEnabled,
  );
