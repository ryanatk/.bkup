...
![image](https://github.com/jest-community/vscode-jest/raw/HEAD/images/v5-output-terminals.png)
...
## Releases 
- **stable** ([v5.1.0](https://github.com/jest-community/vscode-jest/releases/tag/v5.1.0)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v5.1.md#v510)
- **previous** ([v4.6.0](https://github.com/jest-community/vscode-jest/releases/tag/v4.6.0)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v4.md#v460)
...
- Multi-root monorepo project in a single-root workspace will need to be converted to a multi-root project first. From v5, you can quickly perform this with the [monorepo setup tool](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md#setup-monorepo-project).

For more details see the [setup too](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md) and the complete customization options in [settings](#settings).
...
1. test tree item inline menu (see [toggle coverage](https://github.com/jest-community/vscode-jest/blob/HEAD/how-to-toggle-coverage))
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/status-bar-watch-coverage.png" alt="status-bar-modes" width="500"/>
...
The easiest way to setup the monorepo projects is to use the [Setup Tool](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md#setup-monorepo-project) and choose **Setup monorepo project**
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/testExplorer.png" alt="testExplorer.png" width="800"/>
...
### Jest failed to run
  ...
  - <a id="trouble-jest-cmdline"></a>**jest command line issue**: such as you usually run `yarn test` but the extension uses the default `jest` instead.
    ...
    - or you can use the **"Run Setup Tool"** button in the error panel to resolve the configuration issue, see [Setup Tool](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md).  
  - **monorepo project issue**: you have a monorepo project but might not have been set up properly. 
    - short answer is try [Setup monorepo project](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md#setup-monorepo-project) tool. Or read more detail in [how to use the extension with monorepo projects](#how-to-use-the-extension-with-monorepo-projects).
